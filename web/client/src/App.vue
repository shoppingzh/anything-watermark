<template>
  <div id="app">
    <Steps :current="step">
      <Step title="选择文件" content="支持pdf、视频、图片" @click.native="step = 0">
      </Step>
      <Step title="设计水印" content="设计你想要的水印效果" @click.native="step = 1"></Step>
      <Step title="生成" content="生成水印并下载" @click.native="step = 2"></Step>
    </Steps>
    <div class="steps">
